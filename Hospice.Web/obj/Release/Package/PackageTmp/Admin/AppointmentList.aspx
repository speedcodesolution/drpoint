                        ...
                        <asp:Repeater ID="rptAppointmentListing" runat="server" OnItemCommand="rptAppointmentListing_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="editbl"><asp:HiddenField ID="hfpatientid" runat="server"  Value='<%#Eval("PatientId") %>'/><asp:HiddenField ID="hfserviceid" runat="server" Value='<%#Eval("Serviceid") %>'/> <asp:HiddenField ID="hfapptdt" runat="server" Value='<%#Eval("ApptDate") %>'/><a href="PrintBill.aspx"><i class="icon-printer"></i></a> <%--<a href="#" onclick="openPaymentModal(event)>800</a> --%>
                                    ...
                                    <td class="editappnt">
                                        ...
                                        <table style="width:100%">
                                            <tr >
                                        <td ><%#(DateTime.Parse(Eval("ApptTime").ToString())>DateTime.Parse("12:00"))? DateTime.Parse(Eval("ApptTime").ToString()).ToString("hh:mm")+" PM":DateTime.Parse(Eval("ApptTime").ToString()).ToString("hh:mm")+" AM" %>  </td>
                                        <td ><%#Eval("StatusName").ToString().ToUpper() %>  </td>
                                        <td ><%#Eval("Doctor") %>  </td>
                                        <td ><%#Eval("ServiceName") %>  
